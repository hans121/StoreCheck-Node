                ...
                for(var i = 0; i < points.length; i += ps){
                    ...
                    if(series.stack != null){
                        if(series.bars.horizontal) {
                            point[axes[hs]] = (points[barNumber]);
                        } else {
                    ...
                    var text_decimal = text.toString(10);
                    if(series.bars.horizontal) {
                        ctx.fillText(text_decimal, c.left + offset.left + ctx.measureText(text_decimal).width, c.top + offset.top);
                    } else {
                        ctx.fillText(text_decimal, c.left + offset.left, c.top + offset.top);
                    }
                }
            }
        });
